...
public class ItemMoney extends Item {
		...
		if (nbt != null) {
			...
			if (money != 0) {
				if (money < 100 && money > -100)
					return "item.money4.coint";
				else if (money > 100 && money % 100 != 0)
					return "item.money4.check";
			} else return "item.money4.check";
		}
	...
	public String getItemStackDisplayName(ItemStack itemStack) {
		...
		if (nbt != null) {
			...
			if (money != 0) {
				if (money < 100 && money > -100)
					StatCollector.translateToLocalFormatted("money4.secondary.name", new Object[] {money});
				else if (money > 100 && money % 100 == 0)
					StatCollector.translateToLocalFormatted("money4.primary.name", new Object[] {money / 100});
				else
					StatCollector.translateToLocalFormatted("money4.value.name", new Object[] {money / 100, money % 100});
			} else
				StatCollector.translateToLocal("money4.none.desc");
		}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean flag) {
		...
		if (nbt != null) {
			...
			if (money != 0) {
				if (money < 100)
					list.add(StatCollector.translateToLocalFormatted("money4.secondary.desc", new Object[] {money}));
				else if (money >= 100 && money % 100 == 0)
					list.add(StatCollector.translateToLocalFormatted("money4.primary.desc", new Object[] {money / 100}));
				else
	...
	public void registerIcons(IIconRegister ir) {
		...
		icon_coint = ir.registerIcon("money4:coint");
		icon_check = ir.registerIcon("money4:check");
	}
